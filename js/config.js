...
var titleCourse = 'Module Introduction'; // ~67 chars before wrap
...
lesson[1] =  new Array( 2,"none","#","Overview");
lesson[2] =  new Array( 4,"none","#","VA-NAGE Master Agreement Curriculum");
lesson[3] =  new Array( 5,"none","#","What to Expect");
lesson[4] =  new Array( 1,"none","#","Lesson Exit");

/*lesson[0] =  new Array( 2,"none","#","Lesson Entry");
lesson[1] =  new Array( 6,"none","#","Overview");
lesson[2] =  new Array( 5,"none","#","What Should Employees Expect?");
lesson[3] =  new Array( 1,"none","#","End of Course");*/
...
var helpDesk_contact="<h3>VA TMS Help Desk</h3><p class=\'contactInfo\'>If you have technical problems while in the course, taking a self&ndash;exam, taking the evaluation or printing a certificate of completion, please contact the VA TMS Help Desk via email at: <a href=\'mailto:VATMSHelp@va.gov?subject=Module%20Introduction\'>VATMSHelp@va.gov</a> or call Monday through Friday between 8:00 AM and 10:00 PM EST toll free at: <span style=\"white-space: nowrap;\">1(866) 496&ndash;0463</span>.</p>"
...
var msgEOC2='<p>You have completed the online learning module titled: &ldquo;Module Introduction.&rdquo;</p> <p>Select the &ldquo;<a href=\"#\" onclick=\"exitCourse();\" onkeypress=\"exitCourse();\">Exit</a>&rdquo; link <em>(please use the Exit link provided in the course rather than the browser&rsquo;s close button)</em> and return to the Talent Management System (TMS) to access other content objects and/or download your completion certificate once all requirements have been met.</p>'; // with final exam (EOC or EOL)
