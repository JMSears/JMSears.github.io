...
*/
var currId, dts;
addEvent(window, 'load', function() {setTimeout(initResources,1000)});
function initResources() {
	...
	for (var i=0, j=dds.length; i<j; i++) { // loop through all of the definitions on the page to do some magic on each
		newText = '';
		newLink = '';
