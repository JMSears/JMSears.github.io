...
var titleCourse = 'Article 8: Counseling'; // ~67 chars before wrap
...
lesson[1] =  new Array( 7,"none","#","What is Article 8?");
lesson[2] =  new Array( 3,"none","#","Counseling Parameters");
lesson[3] =  new Array( 3,"none","#","Written Counseling");
...
var helpDesk_contact="<h3>VA TMS Help Desk</h3><p class=\'contactInfo\'>If you have technical problems while in the course, taking a self&ndash;exam, taking the evaluation or printing a certificate of completion, please contact the VA TMS Help Desk via email at: <a href=\'mailto:VATMSHelp@va.gov?subject=Article%208:%20Counseling\'>VATMSHelp@va.gov</a> or call Monday through Friday between 8:00 AM and 10:00 PM EST toll free at: <span style=\"white-space: nowrap;\">1(866) 496&ndash;0463</span>.</p>"
...
var msgEOC2='<p>You have completed the online learning module titled: &ldquo;Article 8: Counseling.&rdquo;</p> <p>Select the &ldquo;<a href=\"#\" onclick=\"exitCourse();\" onkeypress=\"exitCourse();\">Exit</a>&rdquo; link <em>(please use the Exit link provided in the course rather than the browser&rsquo;s close button)</em> and return to the Talent Management System (TMS) to access other content objects and/or download your completion certificate once all requirements have been met.</p>'; // with final exam (EOC or EOL)
